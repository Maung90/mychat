            ...
            InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Chat(nama : "Sarah"),
                    ),
                  );
                },
                child: chatBiru('assets/images/2.png',"Sarah", "01 : 02", "Lorem ipsum dolor sit amet, cons.."),
                ),
  ...
  return Container(
    ...
    child : Row(
      ...
      Container(
        ...
        child : Column(
          children : [
          Text(jam, style : const TextStyle(fontSize : 14, 
